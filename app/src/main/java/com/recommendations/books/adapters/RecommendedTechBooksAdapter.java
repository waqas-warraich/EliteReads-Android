...
public class RecommendedTechBooksAdapter extends FirestoreRecyclerAdapter<Book, RecommendedTechBooksAdapter.RecommendedTechBooksVH > {

    Context context;

    public RecommendedTechBooksAdapter(@NonNull FirestoreRecyclerOptions<Book> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull RecommendedTechBooksVH holder, int position, @NonNull Book model) {

        if(model.getBookImageUrl()!=null)
        {
            if(model.getBookImageUrl().length()>10)
    ...
    @NonNull
    @Override
    public RecommendedTechBooksVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecommendedTechBooksVH(v);
    }

    public class RecommendedTechBooksVH extends RecyclerView.ViewHolder{
        ...
        public RecommendedTechBooksVH(@NonNull View itemView) {
            super(itemView);
